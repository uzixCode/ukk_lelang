...
class History_lelang_model extends CI_Model {

	protected $table = 'history_lelang'; // Memanggil tabel history_lelang
	protected $id = 'id_history'; // ID Primary Key pada history_lelang
